  ...
  return (
    <div id="Contact" className="pb-72 mt-36">
      ...
      <div className="text-[#a2aabc] text-lg mt-5 mx-12 lg:mx-60 flex flex-col items-center text-justify">
        <code>
          Saat ini sedang mencari lowongan kerja baru, silakan hubungi dengan mengeklik tombol di bawah ini. <br />
          Jika Anda memiliki pertanyaan atau hanya ingin menyapa, jangan ragu untuk menghubungi. Saya akan berusaha sebaik mungkin untuk membalas!
        </code>
